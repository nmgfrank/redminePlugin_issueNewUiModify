...
module IssueNewUIModify
    module TimelogControllerPatch
        def self.included(base)
            ...
            base.class_eval do 
              before_filter :authorize, :except => [:new, :index, :report, :panel]
              before_filter :find_optional_project, :only => [:index, :report, :panel]           
...
TimelogController.send(:include, IssueNewUIModify::TimelogControllerPatch)
